...
from .models import User, PromoCode, Product, ProductPrintArea, PrintDesign, Order, OrderPrint, ReadyForDelivery
...
class ProductAdmin(admin.ModelAdmin):
    list_display = ['product_id', 'model', 'size', 'color', 'quantity', 'price']
...
class PrintDesignAdmin(admin.ModelAdmin):
    list_display = ['print_id', 'name', 'price']
    search_fields = ['name']
...
class OrderPrintAdmin(admin.ModelAdmin):
    ...
    list_filter = ['order', 'print_design']
